		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content" onmouse>
				<div class="modal-header">
					...
					<a href="ticket-management-admin.php" type="button" class="btn-close fs-4" aria-label="Close"></a>
				</div>
				...
				<div class="modal-footer">
					<a href="ticket-management-admin.php" class="btn btn-primary fs-4 px-5">OK</a>
				</div>
			</div>
		</div>
	</div>	
							...
							<ul class="pagination">
								...
								<?php
									...
									if ($page == 1) {
										...
										echo "<li class='page-item'><a class='page-link fs-4 text-dark disabled' href='ticket-management-admin.php?page=" . $page - 1 . "'>Previous</a></li>";
									}
									else {
										// else (not in page 1), enable previous button
										echo "<li class='page-item'><a class='page-link fs-4 text-dark' href='ticket-management-admin.php?page=" . $page - 1 . "'>Previous</a></li>";
									}
									...
									if ($page - 2 > 0 && intval($_SESSION['excess']) == 0) {
										...
										echo "<li class='page-item'><a class='page-link fs-4 text-dark' href='ticket-management-admin.php?page=" . $page - 2 . "'>" . $page - 2 . "</a></li>";
									}
									
									if ($page - 1 > 0) {
										// if on page 2 or higher, print previous page
										echo "<li class='page-item'><a class='page-link fs-4 text-dark' href='ticket-management-admin.php?page=" . $page - 1 . "'>" . $page - 1 . "</a></li>";
									}

									// print the active page
									echo "<li class='page-item active fs-4 text-dark'><a class='page-link fs-4 text-light' href='ticket-management-admin.php?page=" . $page . "'>" . $page . "</a></li>";
									...
									if (intval($_SESSION['excess']) == 0) {
										...
										echo "<li class='page-item'><a class='page-link fs-4 text-dark disabled' href='ticket-management-admin.php?page=" . $page + 1 . "'>Next</a></li>";
									}
									else {
										// else, enable next button
										echo "<li class='page-item'><a class='page-link fs-4 text-dark' href='ticket-management-admin.php?page=" . $page + 1 . "'>Next</a></li>";
									}
...
<script>
    ...
    for (let btn of details_triggers) {
		btn.addEventListener('click', () => {
            ...
            window.location.href = "ticket-management-admin.php?ticket_details=" + btn.parentNode.parentNode.childNodes[0].innerHTML;
	...
	const details_modal = document.getElementById("details-modal").addEventListener('click', (e) => {
		if (Array.from(e.target.classList).includes("modal")) {
			window.location.href = "ticket-management-admin.php";
		}
